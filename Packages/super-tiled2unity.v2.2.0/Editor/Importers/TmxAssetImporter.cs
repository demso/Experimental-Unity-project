...
namespace SuperTiled2Unity.Editor
{
    ...
    public partial class TmxAssetImporter : TiledAssetImporter
    {
        ...
        protected override void InternalOnImportAsset()
        {
            ...
            //сохранение тайлсета на будущее
            GameObject gh = GameObject.Find("Game Handler");
            m_MapComponent.m_Tiles = new SerializedDictionary<int,SuperTile>();
            var tls = m_GlobalTileDatabase.getTiles();
            foreach (var key in tls.Keys)
            {
                tls.TryGetValue(key, out var tile);
                m_MapComponent.m_Tiles.Add(key, tile);
            }
